...
class AppRouter {
  ...
  static const String initialRoute = Routes.AllPagesScreen;
  ...
  static Route<dynamic>? generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      // case Routes.AllPagesScreen:
      //   return buildPageRoute(const AllPagesScreen(), settings.name!);
      default:
        return _errorRoute();
    }
  }

  static MaterialPageRoute<dynamic> buildPageRoute(Widget screen, String name) {
